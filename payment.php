...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>K-Transport | Make Payment</title>
        ...
        <?php include('includes/navbar.php'); ?>
          ...
          <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Make Payment</h4>
        ...
        <main class="main">
            <div class="container mt-5">
                <div class="row justify-content-center mb-4">
                    <div class="col-md-2">
                        <img src="img/mastercard.png" class="img-fluid mastercard ms-4" style="width:80px;" alt="">
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <form id="paymentForm">
                                    ...
                                    <div class="form-submit mt-3">
                                        <button type="submit" class=" form-control" onclick="payWithPaystack()"> Pay </button>
                                    </div>
                                </form>
                            </div>
                        </div>
