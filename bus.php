        ...
        <?php include('includes/navbar.php'); ?>
          ...
          <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Buses</h4>
                <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item active text-primary">Buses</li>
                </ol>    
            </div>
        </div>
        <!-- Header End -->
            ...
            <div class="container py-5">
                <div class="row mb-3">
                    <div class="col-xl-6 col-md-6 col-sm-12">
                        <img src="img/bus1.jpeg" class="img-fluid" alt="">
                    </div>
                    <div class="col-xl-6 col-md-6 col-sm-12">
                        <div class="mt-5 mb-3">
                            <span><strong>Name:</strong></span>
                            <span>Caoster Bus</span><br>
                            <span><strong>Total Number of seats:</strong></span>
                            <span>24</span><br>
                            <span><strong>Number of Booked seats:</strong></span>
                            <span>0</span><br>
                            <span><strong>Number of Reeserved seats:</strong></span>
                            <span>0</span><br>

                        </div>
                        <div>
                            <a href="book.php" class="btn btn-success">Book a Seat</a>
                        </div>
